...
public class MaplePacketCreator
{
     ...
     * @return
     */
    public static byte[] showMonsterRiding(int cid, MapleMount mount)
    ...
    public static byte[] showMagnet(int mobid, byte success)
    { // Monster Magnet
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] catchMessage(int message)
    { // not done, I guess
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] owlOfMinerva(MapleClient c, int itemid, List<HiredMerchant> hms, List<MaplePlayerShopItem> items)
    ...
    public static byte[] getHiredMerchant(MapleCharacter chr, HiredMerchant hm, boolean firstTime)
    {//Thanks Dustin
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendOpcode.PLAYER_INTERACTION.getValue());
        mplew.write(PlayerInteractionHandler.Action.ROOM.getCode());
    ...
    public static byte[] giveFinalAttack(int skillid, int time)
    ...
    public static byte[] pyramidScore(byte score, int exp)
