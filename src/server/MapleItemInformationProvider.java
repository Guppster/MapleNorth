                        ...
                        case 2049102:
                            ...
                            else
                            {
                                ...
                                if (nEquip.getStr() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setStr(getMaximumShortMaxIfOverflow(nEquip.getStr(), (nEquip.getStr() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setStr(getMaximumShortMaxIfOverflow(0, (nEquip.getStr() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getDex() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setDex(getMaximumShortMaxIfOverflow(nEquip.getDex(), (nEquip.getDex() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setDex(getMaximumShortMaxIfOverflow(0, (nEquip.getDex() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getInt() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setInt(getMaximumShortMaxIfOverflow(nEquip.getInt(), (nEquip.getInt() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setInt(getMaximumShortMaxIfOverflow(0, (nEquip.getInt() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getLuk() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setLuk(getMaximumShortMaxIfOverflow(nEquip.getLuk(), (nEquip.getLuk() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setLuk(getMaximumShortMaxIfOverflow(0, (nEquip.getLuk() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getWatk() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setWatk(getMaximumShortMaxIfOverflow(nEquip.getWatk(), (nEquip.getWatk() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setWatk(getMaximumShortMaxIfOverflow(0, (nEquip.getWatk() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getWdef() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setWdef(getMaximumShortMaxIfOverflow(nEquip.getWdef(), (nEquip.getWdef() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setWdef(getMaximumShortMaxIfOverflow(0, (nEquip.getWdef() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getMatk() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setMatk(getMaximumShortMaxIfOverflow(nEquip.getMatk(), (nEquip.getMatk() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setMatk(getMaximumShortMaxIfOverflow(0, (nEquip.getMatk() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getMdef() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setMdef(getMaximumShortMaxIfOverflow(nEquip.getMdef(), (nEquip.getMdef() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setMdef(getMaximumShortMaxIfOverflow(0, (nEquip.getMdef() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getAcc() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setAcc(getMaximumShortMaxIfOverflow(nEquip.getAcc(), (nEquip.getAcc() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setAcc(getMaximumShortMaxIfOverflow(0, (nEquip.getAcc() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getAvoid() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setAvoid(getMaximumShortMaxIfOverflow(nEquip.getAvoid(), (nEquip.getAvoid() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setAvoid(getMaximumShortMaxIfOverflow(0, (nEquip.getAvoid() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getSpeed() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setSpeed(getMaximumShortMaxIfOverflow(nEquip.getSpeed(), (nEquip.getSpeed() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setSpeed(getMaximumShortMaxIfOverflow(0, (nEquip.getSpeed() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getJump() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setJump(getMaximumShortMaxIfOverflow(nEquip.getJump(), (nEquip.getJump() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setJump(getMaximumShortMaxIfOverflow(0, (nEquip.getJump() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getHp() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setHp(getMaximumShortMaxIfOverflow(nEquip.getHp(), (nEquip.getHp() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setHp(getMaximumShortMaxIfOverflow(0, (nEquip.getHp() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                                if (nEquip.getMp() > 0)
                                {
                                    if (ServerConstants.USE_ENHANCED_CHSCROLL == true)
                                    {
                                        nEquip.setMp(getMaximumShortMaxIfOverflow(nEquip.getMp(), (nEquip.getMp() + Randomizer.nextInt(6) * inc)));
                                    }
                                    else
                                    {
                                        nEquip.setMp(getMaximumShortMaxIfOverflow(0, (nEquip.getMp() + Randomizer.nextInt(6) * inc)));
                                    }
                                }
                            }
                            break;
